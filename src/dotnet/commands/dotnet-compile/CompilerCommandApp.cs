...
namespace Microsoft.DotNet.Tools.Compiler
{
    ...
    public class CompilerCommandApp
    {
        ...
        public int Execute(OnExecute execute, string[] args)
        {
            _app.OnExecute(() =>
            {
                ...
                if (!string.IsNullOrEmpty(FrameworkValue))
                {
                    ...
                    targets = FilterProjectContextsByFramework(targets, NuGetFrameworkValue);
        ...
        public static List<ProjectContext> FilterProjectContextsByFramework(List<ProjectContext> contexts, NuGetFramework framework)
        {
